...
|-----------------------------|--------------|------------------|
| `UCSBDiningCommonsMenuItem` | Tiger        | tigeryu8900      |
| `UCSBOrganization`          | Kyle         | KyleWong288      |
| `RecommendationRequest`     | Ray          | raysujf          |
| `MenuItemReview`            | Richard      | huangderful      |
| `HelpRequest`               | Jonathan     | JonathanCheng123 |
